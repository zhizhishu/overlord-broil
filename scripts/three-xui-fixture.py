#!/usr/bin/env python3
"""Small stateful 3x-ui API fixture for local regression tests."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run a local 3x-ui API fixture.")
    ...
    print(f"3x-ui fixture listening on http://{host}:{port}", flush=True)
