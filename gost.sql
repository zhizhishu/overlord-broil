...
CREATE TABLE `control_server` (
  ...
  `xui_endpoint` varchar(255) DEFAULT NULL,
  `xui_base_path` varchar(100) DEFAULT NULL,
  `xui_api_token` varchar(512) DEFAULT NULL,
  `xui_username` varchar(100) DEFAULT NULL,
  `xui_password` varchar(512) DEFAULT NULL,
  `xui_two_factor_code` varchar(255) DEFAULT NULL,
  `xui_allow_insecure` int(1) NOT NULL DEFAULT '0',
  `xui_last_sync` bigint(20) DEFAULT NULL,
  ...
  `xui_service_status` varchar(30) DEFAULT NULL,
